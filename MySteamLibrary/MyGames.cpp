...
void MyGames::getGameInput()
{
	cout << "This program is designed to keep track of my steam library, "
		<< "and one day maybe index my games by description./n" <<
		"You will be asked to enter the name, developer, publisher, genre, rating and price of each game to put it on the list.";
